...
struct ngx_connection_s
{
	...
	//------------------------------------	
	unsigned                  instance;     //【位域】失效标志位：0：有效，1：失效【这个是官方nginx提供，到底有什么用，ngx_epoll_process_events()中详解】  
...
private:
	...
	ssize_t sendproc(lpngx_connection_t c,char *buff,ssize_t size);       //将数据实际发送到客户端 
...
private:
	...
	pthread_mutex_t                m_sendMessageQueueMutex;               //发送队列互斥量
